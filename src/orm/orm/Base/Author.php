...
use orm\orm\AuthorQuery as ChildAuthorQuery;
use orm\orm\Map\AuthorTableMap;
...
abstract class Author implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\orm\\orm\\Map\\AuthorTableMap';
    ...
    /**
     * Initializes internal state of orm\orm\Base\Author object.
     */
     ...
     * @return $this|\orm\orm\Author The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\orm\\orm\\Author'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\orm\orm\Author The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \orm\orm\Author (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \orm\orm\Author Clone of current object.
     * @throws PropelException
     */
