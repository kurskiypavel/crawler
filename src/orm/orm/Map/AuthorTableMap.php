...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'orm.orm.Map.AuthorTableMap';
     ...
     */
    const OM_CLASS = '\\orm\\orm\\Author';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'orm.orm.Author';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\orm\\orm\\Author');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \orm\orm\Author) { // it's a model object
