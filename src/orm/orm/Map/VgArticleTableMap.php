...
class VgArticleTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Subtitle', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'subtitle', ),
        self::TYPE_COLNAME       => array(VgArticleTableMap::COL_ID, VgArticleTableMap::COL_TITLE, VgArticleTableMap::COL_SUBTITLE, ),
        self::TYPE_FIELDNAME     => array('id', 'title', 'subtitle', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Subtitle' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'subtitle' => 2, ),
        self::TYPE_COLNAME       => array(VgArticleTableMap::COL_ID => 0, VgArticleTableMap::COL_TITLE => 1, VgArticleTableMap::COL_SUBTITLE => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'title' => 1, 'subtitle' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
