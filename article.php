...
foreach ($contentsRU as $index => $content) {
    if (strstr($content, "<img") == false) {

        $htmlOutput .= "<p id='$id" . "i" . "$index" . "in'>" . $content . "</p>";
        $metaDescriptionFull .= $content;
    } else{
        $htmlOutput .= $content;
    }
}
...
<head>
    ...
    <meta name="description"
          content="<?=mb_strimwidth($metaDescriptionFull,0,260,"","UTF-8");?>"/>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-86641861-2"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-86641861-2');
    </script>
    <!-- Global site tag (gtag.js) - Google Analytics -->



    <!-- Yandex.Metrika counter --> <script type="text/javascript" > (function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)}; m[i].l=1*new Date();k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}) (window, document, "script", "https://mc.yandex.ru/metrika/tag.js", "ym"); ym(56335030, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true, webvisor:true }); </script> <noscript><div><img src="https://mc.yandex.ru/watch/56335030" style="position:absolute; left:-9999px;" alt="" /></div></noscript> <!-- /Yandex.Metrika counter -->
</head>
<!--[if lte IE 9]>
